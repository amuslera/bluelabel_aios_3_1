...
# Use v3.1 adapter instead of original orchestrator
try:
    # When run as a module
    from .v31_orchestrator_adapter import TheatricalOrchestrator
    from .theatrical_orchestrator import TheatricalEvent
except ImportError:
    # When run directly
    from v31_orchestrator_adapter import TheatricalOrchestrator
    from theatrical_orchestrator import TheatricalEvent
